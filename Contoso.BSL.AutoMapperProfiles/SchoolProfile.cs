...
#pragma warning restore S3776
        {
            ...
            CreateMap<DepartmentModel, Department>()
                ...
                (
                    ...
                    opts => opts.MapFrom
                    (
                        x => BaseDbContextSqlFunctions.FormatDateTime(x.StartDate, "MM/dd/yyyy", culture)
                    )
                )
                .ForMember
                (
                    ...
                    opts => opts.MapFrom
                    (
                        x => BaseDbContextSqlFunctions.FormatDecimal(x.Budget, "F2", culture)
                    )
                )
                .ForAllMembers(o => o.ExplicitExpansion());
...
#pragma warning restore S3358
            ...
            CreateMap<InstructorModel, Instructor>()
                ...
                (
                    ...
                    opts => opts.MapFrom
                    (
                        x => BaseDbContextSqlFunctions.FormatDateTime(x.HireDate, "MM/dd/yyyy", culture)
                    )
                )
                .ForAllMembers(o => o.ExplicitExpansion());
            ...
            (
                ...
                opts => opts.MapFrom
                (
                    x => BaseDbContextSqlFunctions.FormatDateTime(x.EnrollmentDate, "MM/dd/yyyy", culture)
                )
            )
            .ForAllMembers(o => o.ExplicitExpansion());
