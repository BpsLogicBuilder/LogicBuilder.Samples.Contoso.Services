...
{
    public class DeleteCourseTest : IClassFixture<DatabaseFixture>
    {
        static DeleteCourseTest()
        {
            InitializeMapperConfiguration();
        }

        public DeleteCourseTest(DatabaseFixture databaseFixture, ITestOutputHelper output)
        {
        ...
        public async Task DeleteValidCourseRequest()
        {
            ...
            course = (await schoolRepository.GetAsync<CourseModel, Course>(s => s.Title == "Composition")).SingleOrDefault();
        ...
        public async Task DeleteInvalidCourseRequest()
        {
            ...
            course = (await schoolRepository.GetAsync<CourseModel, Course>
            (
                s => s.Title == "Composition"
            )).SingleOrDefault();
